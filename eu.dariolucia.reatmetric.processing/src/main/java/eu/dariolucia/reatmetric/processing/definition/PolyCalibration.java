...
public class PolyCalibration extends CalibrationDefinition implements Serializable {
    ...
    public PolyCalibration() {
    }

    public PolyCalibration(double a0, double a1, double a2, double a3, double a4, double a5) {
        this.a0 = a0;
        this.a1 = a1;
        this.a2 = a2;
        this.a3 = a3;
