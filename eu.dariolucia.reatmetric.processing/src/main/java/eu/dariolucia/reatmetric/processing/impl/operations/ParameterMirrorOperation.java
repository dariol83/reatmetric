...
public class ParameterMirrorOperation extends AbstractModelOperation<ParameterProcessor> {

    private final ParameterData input;

    public ParameterMirrorOperation(ParameterData input) {
        this.input = input;
    }
    ...
    public String toString() {
        return "'Mirror Parameter " +
                input.getExternalId() + " with state " + input + "'";
    }
}
