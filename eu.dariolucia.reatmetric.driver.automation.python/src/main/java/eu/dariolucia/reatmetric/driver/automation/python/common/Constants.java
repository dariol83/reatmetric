...
package eu.dariolucia.reatmetric.driver.automation.python.common;

public class Constants {
    // Activity Type
    public static final String T_SCRIPT_TYPE = "PYTHON_SCRIPT";
    ...
    public static final String AUTOMATION_ROUTE = "Python Automation Engine";
