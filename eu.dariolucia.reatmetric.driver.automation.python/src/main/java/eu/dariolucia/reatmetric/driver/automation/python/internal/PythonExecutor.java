...
package eu.dariolucia.reatmetric.driver.automation.python.internal;
...
import eu.dariolucia.reatmetric.driver.automation.base.common.ScriptExecutionManager;
...
public class PythonExecutor implements IScriptExecutor {
    ...
    public PythonExecutor(DataSubscriptionManager dataSubscriptionManager, IServiceCoreContext context, String initData, String contents, IActivityHandler.ActivityInvocation activityInvocation, String fileName) {
    ...
    public Object execute() throws ScriptException {
        ...
        try {
            ...
            for (Map.Entry<String, Object> entry : invocation.getArguments().entrySet()) {
                if (!entry.getKey().equals(AutomationConstants.ARGUMENT_FILE_NAME)) {
