...
eu.dariolucia.reatmetric.driver.spacecraft.connectors. A further example (TC frame/TM frame TCP/IP connector)
...
with the exception of the packet structure and mapping, the configuration is not easy to understand. Therefore, the
...
<ns1:spacecraft xmlns:ns1="http://dariolucia.eu/reatmetric/driver/spacecraft">
	...
	<tc randomize="true" fecf="true" ad-mode-default="true">
        <!-- TC VC configuration
        TODO: implement support for use-security
        -->
	...
	<tm-packet parameter-id-offset="100000">
		...
		<default-pus-configuration
            ...
            <!-- <obt-cds-config explicit-p-field="false" short_days="true" subtime_byte_res="2" /> TODO: change underscores -->
		</default-pus-configuration>
