 ...
 * this interface must be able to report the source and the list of supported raw data types that it can render.
 */
public interface IRawDataRenderer {

    /**
     * The source identifier that this object can render.
     *
