...
public interface IRawDataRenderer {
     ...
     *
     * TODO what about data such as TC, which are generated by ReatMetric? Change to List of Pair String, String (source, type) ?
     *  Or use the route? in reality for outgoing raw data I would need a destination field... or maybe I need to have a new field called
     *  "processor" which is the name of the driver?
     *
