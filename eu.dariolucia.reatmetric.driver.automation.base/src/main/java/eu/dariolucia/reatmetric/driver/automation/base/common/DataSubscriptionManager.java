...
public class DataSubscriptionManager {
    ...
    public synchronized void subscribe(IEventDataSubscriber s, int externalId) {
    ...
    public synchronized void subscribe(IActivityOccurrenceDataSubscriber s, int externalId) {
    ...
    public synchronized void subscribe(IParameterDataSubscriber s, int externalId) {
    ...
    public synchronized void unsubscribe(IActivityOccurrenceDataSubscriber s, int externalId) {
    ...
    public synchronized void unsubscribe(IEventDataSubscriber s, int externalId) {
    ...
    public synchronized void unsubscribe(IParameterDataSubscriber s, int externalId) {
