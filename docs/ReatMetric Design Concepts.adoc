...
handler_, the outgoing route must be indicated. If the route is not available, then the dispatch of the activity
occurrence fails.
...
- A route is declared as managed by an activity handler;
